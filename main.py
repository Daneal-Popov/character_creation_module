...
def attack(char_name: str, char_class: str):
    """Calculates how much damage is dealt to the enemy."""
...
def defence(char_name: str, char_class: str):
    """Сalculates how much damage was blocked."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str):
    ...
    return (f'{char_name} не преминил специальное умение')


def start_training(char_name: str, char_class: str):
    """Training. takes a value from the user and
...
if __name__ == '__main__':
    def main() -> None:
        """Beginning of the game. Greetings."""
        run_screensaver()
